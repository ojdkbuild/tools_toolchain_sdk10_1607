...
ECHO "Running command start "DismFod" %SystemFolder%\dism.exe /online /NoRestart /add-capability /capabilityname:Tools.Graphics.DirectX~~~~0.0.1.0"
start "%App%" "%SystemFolder%\%App%" /online /NoRestart /add-capability /capabilityname:Tools.Graphics.DirectX~~~~0.0.1.0
